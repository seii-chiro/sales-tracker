...
const InventoryTable = ({
  ...
  const hasPendingDelete = deletingItemId !== null;
            ...
            <div className="space-y-2">
              <label className="block text-xs font-medium text-slate-600">
                ...
                <input
                  ...
                  accept="image/*"
                  disabled={
                    actionDisabled || hasPendingDelete || uploadingItemId === item.id
                  }
                  onChange={(event) => {
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  disabled={actionDisabled || hasPendingDelete}
                ...
                <button
                  ...
                  disabled={actionDisabled || hasPendingDelete}
                  className="w-full rounded-lg border border-rose-300 px-3 py-2 text-sm font-medium text-rose-700 transition hover:bg-rose-50 disabled:cursor-not-allowed disabled:text-rose-300"
                >
                ...
                <td className="px-4 py-3 text-right">
                  <div className="flex justify-end gap-2">
                    ...
                    <button
                      ...
                      disabled={actionDisabled || hasPendingDelete}
                      className="rounded-lg border border-rose-300 px-3 py-2 text-sm font-medium text-rose-700 transition hover:bg-rose-50 disabled:cursor-not-allowed disabled:text-rose-300"
                    >
                      {deletingItemId === item.id ? "Removing..." : "Remove"}
                    </button>
                  </div>
